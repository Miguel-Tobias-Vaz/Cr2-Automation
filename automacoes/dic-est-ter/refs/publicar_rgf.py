# =====================================================================
#  Central de publicacoes CR2 — RGF, RREO, Balancete e Balanco/Relatorios Anuais (Playwright)
# =====================================================================
#
#  Documentacao (dependencias, pastas/URLs, linha de comando, mapa de funcoes):
#    README_publicador_CR2.md  (nesta pasta Certas/)
#
...
OPERA_EXE = None
PASTA_SCREENSHOTS = Path(__file__).resolve().parent.parent / "runtime" / "screenshots"
...
def extrair_meta_rgf(pdf_path):
    """
    Retorna dict com ano, referencia_tipo (quadrimestre|semestre), referencia_num,
...
def _variantes_referencia_rgf(meta):
    ...
    if meta.get("referencia_tipo") == "semestre":
...
def verificar_playwright_instalado():
    ...
    print("\n       Tente no terminal (pasta Certas):")
...
if __name__ == "__main__":
    ...
    if "--help" in sys.argv or "-h" in sys.argv:
        print(
            "Uso: python \"Atomação - publicar RGF.py\" [opcoes]\n\n"
